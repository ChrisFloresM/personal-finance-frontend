function TransactionsTableHead() {
  return (
    <thead className="border-b-grey-100 hidden border-b md:block">
      <tr className="[&_th]:text-preset-5 [&_th]:leading-preset-5 [&_th]:text-beige-500 grid grid-cols-7 gap-x-300 py-150 [&_th]:text-start [&_th]:font-normal [&_th:last-child]:text-end">
        ...
        <th className="col-span-1 justify-self-end">Amount</th>
        <th className="col-span-1">Options</th>
      </tr>
    </thead>
  );
}
